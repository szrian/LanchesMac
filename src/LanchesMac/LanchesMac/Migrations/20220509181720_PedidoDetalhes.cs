        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PedidoTotal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalItensPedido = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PedidoEnviado = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PedidoEntregueEm = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
